...
{
    printf("\n\r[%s] Starting Heap NN OTA update\n\r", __FUNCTION__);
    ...
    uint32_t cur_block = 0;
    int boot_sel = 0;
    uint8_t target_fw_idx = OTA_NN_MDL;   // nn always flash into primary
    _file_checksum file_checksum;
    file_checksum.u = 0;
    ...
    printf("\n\r[%s] NN OTA update completed successfully\n\r", __FUNCTION__);
...
{
    printf("\n\r[%s] Starting Heap ISP IQ OTA update\n\r", __FUNCTION__);
    ...
    uint32_t cur_block = 0;
    int boot_sel = 0;
    uint8_t target_fw_idx = OTA_ISP_IQ;   // ISP IQ always flash into primary
    _file_checksum file_checksum;
    file_checksum.u = 0;
    ...
    while (idx < length) {
        ...
        printf("[ISP IQ updating] ============================== updating: %u / %u Bytes\n", idx, (length - 4));
    ...
    printf("\n\r[%s] ISP IQ OTA update completed successfully\n\r", __FUNCTION__);
