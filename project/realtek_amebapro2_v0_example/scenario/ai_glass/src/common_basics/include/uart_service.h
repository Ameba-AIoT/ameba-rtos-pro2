...
enum {
	...
	AI_GLASS_WIFI_BL_OTA_FAILED                 = 0x09,
	AI_GLASS_WIFI_NN_OTA_FAILED                 = 0x0A,
	AI_GLASS_WIFI_ISP_IQ_OTA_FAILED             = 0x0B,
	AI_GLASS_WIFI_OTA_MALLOC_FAILED		  		= 0x0C,
	AI_GLASS_WIFI_OLDER_TIMESTAMP_VERSION		= 0x0D,
	AI_GLASS_WIFI_CANCEL_OTA_PROCESS			= 0x0E,
};
