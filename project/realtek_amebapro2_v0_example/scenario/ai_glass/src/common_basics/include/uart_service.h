...
typedef enum {
	...
	UART_RX_OPC_CMD_GET_SYS_UPGRADE             = 0x0635,
	UART_RX_OPC_CMD_CANCEL_SYS_UPGRADE          = 0x0636,
	...
	UART_RX_OPC_CMD_AUDIO_START         = 0x841C,
	UART_RX_OPC_CMD_AUDIO_STOP          = 0x841D,
	UART_RX_OPC_CMD_GET_WIFI_PARAMETER  = 0x841F,
	...
	UART_RX_OPC_CMD_LIVE_START                          = 0x8417,
	UART_RX_OPC_CMD_LIVE_STOP                           = 0x8418,
	UART_RX_OPC_CMD_LIVE_STREAM                         = 0x8419,
	UART_RX_OPC_CMD_RTSP_LIVE_START     = 0x841A,
	UART_RX_OPC_CMD_RTSP_LIVE_STOP      = 0x841B,
...
typedef enum {
	...
	UART_TX_OPC_RESP_GET_SYS_UPGRADE            = 0x0635,
	UART_TX_OPC_RESP_CANCEL_SYS_UPGRADE         = 0x0636,
	...
	UART_TX_OPC_CMD_AUDIO_START         = 0x841C,
	UART_TX_OPC_CMD_AUDIO_STOP          = 0x841D,
	UART_TX_OPC_RESP_AUDIO_RECORD_CONT  = 0x841E,
	UART_TX_OPC_CMD_GET_WIFI_PARAMETER  = 0x841F,
	...
	UART_TX_OPC_CMD_LIVE_START                          = 0x8417,
	UART_TX_OPC_CMD_LIVE_STOP                           = 0x8418,
	UART_TX_OPC_CMD_LIVE_STREAM                         = 0x8419,
	UART_TX_OPC_RESP_RTSP_LIVE_START     = 0x841A,
	UART_TX_OPC_RESP_RTSP_LIVE_STOP      = 0x841B,
...
typedef enum {
	...
	AI_GLASS_DEVICE_WORKING_IN_PROG = 0x22,
...
enum {
	...
	UART_PWR_WIFI_OTA_SUCCESS   				= 0x06,
	UART_PWR_WIFI_OTA_SUCCESS_BT_OTA_READY     	= 0x07,
	AI_GLASS_WIFI_OTA_FAILED	      			= 0x08,
	AI_GLASS_WIFI_BL_OTA_FAILED                 = 0x10,
	AI_GLASS_WIFI_NN_OTA_FAILED                 = 0x11,
	AI_GLASS_WIFI_ISP_IQ_OTA_FAILED             = 0x12,
	AI_GLASS_WIFI_OTA_MALLOC_FAILED		  		= 0x13,
	AI_GLASS_WIFI_OLDER_TIMESTAMP_VERSION		= 0x14,
	AI_GLASS_WIFI_CANCEL_OTA_PROCESS			= 0x15,
};
