...
void *fast_memcpy(void *dest, const void *src, size_t n)
{
	...
	uint32_t dest_align = (4 - ((uintptr_t)d & 3)) & 3;
	if (dest_align > 0) {
		size_t align_count = (n < dest_align) ? n : dest_align;
